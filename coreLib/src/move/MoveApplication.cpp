...
namespace move {
	...
	static void apply_castle(core::Position& position, uint32_t& move) {
	...
	static void apply_en_passant(core::Position& position, uint32_t& move) {
	...
	static void apply_normal_move(core::Position& position, uint32_t& move) {
		core::bit_board::move_bit(
	...
	void apply_move(core::Position& position, uint32_t& move) {
